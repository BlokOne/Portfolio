...
window.onscroll = function () {
   ...
   if (top > 399 && top < 500) {
      ...
      document.querySelector('.app__weather-wrapper').classList.remove('active')

   } else if ( top < 1900 && top > 1700) {
      document.querySelector('.app__weather-wrapper').classList.add('active'),
      document.querySelector('.app__weather-wrapper').addEventListener('click', ()=>{
         document.querySelector('.app__weather-wrapper').classList.remove('active')
         console.log('hi')
      })
      ...
      document.querySelector('.app__calculator-wrapper').classList.remove('active')
   } else if ( top < 2300 && top > 2100) {
      document.querySelector('.app__calculator-wrapper').classList.add('active')
   } 
